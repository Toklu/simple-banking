...
@Component
public class ElectricBillTransactionCommand extends TransactionCommand {

    @Autowired
    public ElectricBillTransactionCommand(TransactionRepository transactionRepository,
    ...
    public TransactionCommandType getType() {
        return TransactionCommandType.ELECTRIC_BILL;
    }
    ...
    public TransactionCommandResult execute(Account account, TransactionRequestInputDTO transactionRequest) {
        ...
        transaction.setSubType(TransactionSubType.ELECTRIC_BILL);
